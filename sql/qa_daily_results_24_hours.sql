...
SELECT
    EWO.WIP_ENTITY_NAME,
    TO_CHAR(EWO.CREATION_DATE, 'MM/DD/YYYY HH24:MI:SS') AS WO_CREATED_DATE_TIME,
    TO_CHAR(EWO.DATE_COMPLETED, 'MM/DD/YYYY HH24:MI:SS') AS WO_CLOSED_DATE_TIME,
    TO_CHAR(QR.QA_CREATION_DATE, 'MM/DD/YYYY HH24:MI:SS') AS QA_CREATED_DATE_TIME,
    EWO.ASSET_ACTIVITY,
